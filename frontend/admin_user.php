...
if (isset($_GET['delete'])){
    ...
    mysqli_query($conn, "DELETE FROM `users` WHERE id = '$delete_id'")or die('query field');
   ...
   ?>
    ...
    <section class="users-container">
        ...
        <div class="box-container">
            <?php 
        $select_users = mysqli_query($conn, "SELECT * FROM `users`") or die('query field');
        ...
        ?>
            <div class="box">
                ...
                <p><?php echo $fetch_users['users'];?></p>
                <a class=" delete" href="admin_user.php?delete=<?php echo $fetch_users['id']; ?>;"
                onclick="return confirm('deletet this user');">delete</a>
            </div>
            <?php 
              }
            } else {
