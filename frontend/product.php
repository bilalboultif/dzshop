...
if (isset($_GET['delete'])){
 ...
 if(isset($_POST['update_product'])){
    ...
    $update_query = mysqli_query($conn, "UPDATE `products` SET `id`='$update_id',`name`='$update_name',`price`='$update_price', `product_detail`='$update_detail', `image`='$update_image' WHERE id = '$update_id'")or die('query field');
    if ($update_query) {
